...
var ArticleController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        xParametre = _a.sent();
                        return [2 /*return*/, res.send({ parameter: xParametre })];
                    case 2:
                        error_1 = _a.sent();
                        console.log(error_1);
                        return [3 /*break*/, 3];
    ...
    //
    ArticleController.prototype.indexQuery = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var query, xParametre, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        query = req.query.type_parametre;
                        return [4 /*yield*/, index_database_1.db
                                .getRepository(parameter_1.Parameter)
                                .find({ relations: { type_parameter: true } })];
                    case 1:
    ...
    //
    ArticleController.prototype.create = function (req, res, profileID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    // Init
