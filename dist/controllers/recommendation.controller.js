...
var RecommendationController = /** @class */ (function () {
    ...
    RecommendationController.prototype.JobBasedOnProfile = function (req, res) {
    ...
    RecommendationController.prototype.theProfilesYouCanFollow = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Init
...
exports.default = new RecommendationController();
